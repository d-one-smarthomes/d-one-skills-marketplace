...
Access Control hardware is confirmed: Entry/Mid on **UniFi** (door intercom + viewer),
Premium on **Savant/2N** — gate intercom `DOR-VERSO2SMN-00`, tag reader `9160347`.

### Testimonials and the "Save my selections" step

- A client **pull-quote** is placed after each major section (project plans, each of the four
